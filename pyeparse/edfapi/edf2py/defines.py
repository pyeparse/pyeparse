...
def create_event_constants():
    ...
    return create_constants(locals())


event_constants = create_event_constants()
...
eye_constants = create_eye_type_constants()
